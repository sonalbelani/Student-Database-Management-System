...
class Login(QDialog):
    ...
    def handleLogin(self):
        if ((self.textName.text() == 'gautam' and
            self.textPass.text() == 'gautam') or (self.textName.text() == '' and
            self.textPass.text() == '')):
            self.accept()
        else:
            QMessageBox.warning(
...
def showStudent(list):
    ...
    if list[4]==0:
        ...
        course_a="COMPUTER VISION"
    elif list[4]==9:
        course_a="DATA SCIENCE"
    elif list[4]==10:
        course_a="BLOCKCHAIN"
    elif list[4]==11:
        course_a="AI/ML"
    ...
    table.setItem(4, 0, QTableWidgetItem("Course A"))
    table.setItem(4, 1, QTableWidgetItem(str(course_a)))
    table.setItem(5, 0, QTableWidgetItem("Course B"))
    table.setItem(5, 1, QTableWidgetItem(str(course_b)))
    table.setItem(6, 0, QTableWidgetItem("Course C"))
